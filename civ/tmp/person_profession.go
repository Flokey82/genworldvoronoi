...
//
// - Add requirements for the professions
//   - shipwright requires wood, nails, etc. and river or sea access
//   - farmer requires arable land
type Profession struct {
	Name          string
	PerPopulation int
	Tick          func(p *Person, nDays int)
	Income        func(p *Person, nDays int) float64
...
var (
	ProfessionHunter = &Profession{
		...
		PerPopulation: 3,
		Income: func(p *Person, nDays int) float64 {
			return 1 * CurrencyCopper * float64(nDays)
		},
	}
	...
	ProfessionFarmer = &Profession{
		...
		PerPopulation: 5,
		Income: func(p *Person, nDays int) float64 {
			return 1.5 * CurrencyCopper * float64(nDays)
		},
	}
	ProfessionFisher = &Profession{
		...
		PerPopulation: 10,
		Income: func(p *Person, nDays int) float64 {
			return 2 * CurrencyCopper * float64(nDays)
		},
	}
	ProfessionCarpenter = &Profession{
		...
		PerPopulation: 20,
		Income: func(p *Person, nDays int) float64 {
			return 5 * CurrencyCopper * float64(nDays)
		},
	}
	...
	ProfessionJeweler = &Profession{
		...
		PerPopulation: 20,
		Income: func(p *Person, nDays int) float64 {
			return 2 * CurrencySilver * float64(nDays)
		},
	}
	ProfessionShipwright = &Profession{
		...
		PerPopulation: 20,
		Income: func(p *Person, nDays int) float64 {
			return 5 * CurrencySilver * float64(nDays)
		},
	}
	...
	ProfessionMiller = &Profession{
		...
		PerPopulation: 100,
		Income: func(p *Person, nDays int) float64 {
			return 1 * CurrencySilver * float64(nDays)
		},
	}
	...
	ProfessionAdministrator = &Profession{
		...
		PerPopulation: 100,
		Income: func(p *Person, nDays int) float64 {
			return 10 * CurrencyGold * float64(nDays)
		},
	}
	...
	ProfessionAmbassador = &Profession{
		...
		PerPopulation: 200,
		Income: func(p *Person, nDays int) float64 {
			return 20 * CurrencyGold * float64(nDays)
		},
	}
	ProfessionSpy = &Profession{
		...
		PerPopulation: 1000,
		Income: func(p *Person, nDays int) float64 {
			return 100 * CurrencyGold * float64(nDays)
		},
	}
...
func (c *Career) Tick(p *Person, nDays int) {
	...
	if c.Profession.Income != nil {
		p.Gold += c.Profession.Income(p, nDays)
	}
}
