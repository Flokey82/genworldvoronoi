...
// AddEventf adds an event to the history, with a formatted message, and returns a pointer to the event.
func (h *History) AddEventf(t string, id ObjectReference, format string, a ...interface{}) *Event {
	return h.AddEvent(t, fmt.Sprintf(format, a...), id)
}
